        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @role('apoteker')
                    <li class="sidebar-item {{ request()->routeIs('pasien.*') ? 'active' : '' }}">
                        <a href="{{ route('pasien.index') }}" class="sidebar-link">
                            <i class="bi bi-people-fill"></i><span>Data Pasien (No RM)</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ request()->routeIs('apotek.*') ? 'active' : '' }}">
                        <a href="#" class="sidebar-link">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('apoteker.resep.*') ? 'active' : '' }}">
                        <a href="#" class="sidebar-link">
                            <i class="bi bi-bell-fill"></i><span>Antrean Resep</span>
                        </a>
                    </li>
                @endrole
